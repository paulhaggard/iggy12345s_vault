...
namespace Neuron_Simulation
{
    class NeuralNetwork
    {
        ...
        public void Train(int iterations, List<List<double>> sample_in, List<List<double>> sample_out, List<List<double>> weight_init = null, List<List<double>> bias_init = null)
        {
